...
def run_scaled_dot_product_attention(
    ...
    """
    return functional.attention(Q, K, V, mask)
...
def run_get_batch(
    ...
    """
    return functional.sample_train_data(dataset, batch_size, context_length, device)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    return functional.softmax(in_features, dim)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    return cs336_basics.model.funtional.gradient_clipping(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return cs336_basics.model.funtional.get_lr_cosine_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
...
def run_save_checkpoint(
    ...
    """
    return cs336_basics.model.funtional.save_checkpoint(model, optimizer, iteration, out)
...
def run_load_checkpoint(
    ...
    """
    return cs336_basics.model.funtional.load_checkpoint(src, model, optimizer)
